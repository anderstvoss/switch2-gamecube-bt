...
| Windows 11 | Native host | Bluetooth | native Windows Bluetooth + PairTool | BEE-021 | bounded SYNC-mode discovery | unverified | observed three times | `observations/2026-07-12-windows-bluetooth-discovery.md` | 2026-07-12 | Adapter available; known-device, association-endpoint, and valid eight-second active PairTool scans returned no candidate. No pairing attempted. |
